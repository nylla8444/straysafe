      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <input
            ...
            className="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border border-gray-300 rounded-md p-2"
        ...
        <div className="flex justify-end">
          <button
            ...
            className={`px-4 py-2 rounded-md text-white font-medium ${loading || !proofImage ? 'bg-teal-300 cursor-not-allowed' : 'bg-teal-600 hover:bg-teal-700'}`}
          >
