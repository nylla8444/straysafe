...
export default function OrganizationPaymentDetailPage() {
    ...
    if (error || !payment) {
        return (
            <div className="max-w-5xl mx-auto p-4">
                ...
                <Link href="/organization/payments" className="text-blue-600 hover:underline">
                    Back to payments
                </Link>
            </div>
        );
    ...
    return (
        <div className="max-w-5xl mx-auto p-4">
            {/* Back link */}
            <div className="mb-6">
                <Link href="/organization/payments" className="inline-flex items-center text-blue-600 hover:text-blue-800">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
                ...
                {activeTab === 'details' && (
                    <div className="p-6">
                        {/* Two column layout for payment and adoption details */}
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    {payment.petId && (
                                        <div className="flex items-center mb-4">
                                            <div className="h-16 w-16 rounded-lg overflow-hidden mr-3 bg-gray-200">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg flex flex-col items-center">
                                            ...
                                            {payment.paymentInstructions && (
                                                <div className="text-sm text-gray-700 text-center">
                                                    ...
                                                    <p>{payment.paymentInstructions}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    <div className="flex items-center border-b border-gray-200 pb-4 mb-4">
                                        ...
                                        <div>
                                            <h3 className="font-medium">{payment.adopterId.firstName} {payment.adopterId.lastName}</h3>
                                            ...
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                <div className="relative h-64 rounded-lg overflow-hidden mb-4 border border-gray-200">
                                                    ...
                                                    <a
                                                        ...
                                                        className="absolute bottom-2 right-2 bg-gray-800 bg-opacity-75 text-white px-3 py-1 rounded-md text-xs flex items-center"
                                                    >
                                                ...
                                                {payment.transactionId && (
                                                    <div className="mb-3">
                                                        ...
                                                        <p className="text-gray-700 font-mono">{payment.transactionId}</p>
                                                    </div>
                                                )}
                        ...
                        {(payment.status === 'verified' || payment.status === 'rejected') && payment.organizationNotes && (
                            <div className="mb-6">
                                ...
                                <div className={`bg-gray-50 p-4 rounded-lg border-l-4 ${payment.status === 'verified' ? 'border-green-500' : 'border-red-500'
                                    ...
                                    <p className="text-gray-700 mt-2">{payment.organizationNotes}</p>
                                    ...
                                    <li key={index}>
                                        <div className="relative pb-8">
                                            ...
                                            <div className="relative flex space-x-3">
                                                <div>
                                                    <span className={`h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white bg-${event.color}-100`}>
                                                        {event.status === 'Created' && (
                                                            <svg className={`h-4 w-4 text-${event.color}-600`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {activeTab === 'verify' && payment.status === 'submitted' && (
                    <div className="p-6">
                        <h2 className="text-lg font-medium mb-4">Verify Payment</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                {(payment.status === 'verified' || payment.status === 'rejected') && (
                    <div className="bg-blue-50 text-blue-600 px-4 py-2 rounded-md flex items-center justify-center">
                        <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            {payment.status === 'verified' ? (
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            ) : (
